    ...
    return function authorizeHttpParams(req, res, next) {
        ...
        try {
            ...
            if (typeof schema === 'string')
                ...
                return next(new Error(`authorizeHttpParams:: Schema need to be a String or Array  on ${req.url}`))
            }
            ...
            if (!result) {
                ...
                return next(new BadRequestError(`authorizeHttpParams:: Bad request Error  on ${req.url}`))
            }
